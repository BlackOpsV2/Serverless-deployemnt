...
const CONFIG = {
  "backend_url": "https://4do5ytwgq1.execute-api.ap-south-1.amazonaws.com/dev/inference"
}
    ...
    <div className="flex min-h-screen flex-col items-center justify-center py-2">
      <main className="flex w-full flex-1 flex-col items-center justify-center px-20 text-center">
        ...
        <div className="mt-10 text-lg">
          Select a PNG Image from <a href="https://github.com/vivekchaudhary07/S9-Serverless-Frontend/blob/main/input.jpg" target="_blank" className='text-blue-600'>Example</a>
        </div>
